...
const TABLE_HEAD = ["Colaborador", "Função","Gestor", "Tipo", "Status", "Data Admissão", ""];
...
export default function TabelaColaboradores() {
  ...
  const breadcrumbItems = [
    { name: "Home", path: "/user" },
    { name: "Colaboradores", path: "/user/colaboradores" },
  ];
                  ...
                  return (
                    <tr key={_id}>
                      <td className={classes}>
                        <div className="flex items-center gap-3">
                          <Avatar src={avatarUrl} alt={informacoes_basicas.nome || "Não informado"} size="sm" />
                          <div className="flex flex-col">
                            ...
                            >
                              {informacoes_basicas.nome || "Não informado"}
                            </Typography>
                            <Typography
                              variant="small"
                              color="blue-gray"
                            ...
                            >
                              {contato?.email_corporativo || "Não informado"}
                            </Typography>
                          </div>
                        </div>
                      </td>
                      <td className={classes}>
                        <div className="flex flex-col">
                          <Typography
                            ...
                            className="font-normal"
                          >
                            {dados_profissionais?.funcao || "Não informado"}
                          </Typography>
                          <Typography
                            variant="small"
                            color="blue-gray"
                            className="font-normal opacity-70"
                          >
                            {dados_profissionais?.area || "Não informado"}
                          </Typography>
                        </div>
                      </td>
                      <td className={classes}>
                        <Typography
                          ...
                          className="font-normal"
                        >
                          {dados_profissionais?.gerente || "Não informado"}
                        </Typography>
                      </td>
                      <td className={classes}>
                        <Typography
                          ...
                          className="font-normal"
                        >
                          {tipo_colaborador || "Não informado"}
                        </Typography>
                      </td>
                      <td className={classes}>
                        <div className="w-max">
                      ...
                      <td className={classes}>
                        <Typography
                          ...
                          className="font-normal"
                        >
                          {dataInicio ? new Date(dataInicio).toLocaleDateString() : "Não informado"}
                        </Typography>
                      </td>
                      <td className={classes}>
